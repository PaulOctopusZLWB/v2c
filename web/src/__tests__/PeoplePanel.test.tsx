...
const people: PersonRow[] = [
  { person_id: "per_a", display_name: "韩文巧", is_self: 0, enrolled: true, attributed_count: 12 },
  { person_id: "per_b", display_name: "李雷", is_self: 0, enrolled: false, attributed_count: 0 }
];
